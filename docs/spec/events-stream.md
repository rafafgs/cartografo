...
- `id` — the envelope's `id`. **It is the cursor**, and it is the only total
  order there is ([taxonomy](../../specs/events/taxonomy.md));
...
[taxonomy](../../specs/events/taxonomy.md)'s eight fields, with the
...
[taxonomy](../../specs/events/taxonomy.md)'s, and not this document's:
