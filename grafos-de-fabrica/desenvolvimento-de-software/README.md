...
`testar`.** Era a mesma classe de divergência do item 2 acima — a cópia do
exemplo-mestre do `t96` envelhecendo enquanto o manifesto, que é o que vale,
seguia em frente. O nó `testar` declarava `evidencia` como string única e
...
estão: é vocabulário de aresta, e traduzi-lo é a divergência 3, ainda aberta.
