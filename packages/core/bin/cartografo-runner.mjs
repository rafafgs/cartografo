#!/usr/bin/env node
/**
 * The `cartografo-runner` command, as the single published package ships it (t248, D23).
 *
 * A delegator and nothing else. The real command is `packages/runner/bin/cartografo-runner.mjs`,
 ...
 * `@cartografo/runner` is a workspace symlink, and inside the published
...
await import('@cartografo/runner/bin/cartografo-runner');
