#!/usr/bin/env node
/**
 * The `cartografo-screen` command, as the single published package ships it (t248, D23).
 *
 * A delegator and nothing else. The real command is `packages/screen/bin/screen.mjs`,
 ...
 * `@cartografo/screen` is a workspace symlink, and inside the published
...
await import('@cartografo/screen/bin/screen');
