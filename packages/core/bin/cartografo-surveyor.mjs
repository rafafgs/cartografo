#!/usr/bin/env node
/**
 * The `cartografo-surveyor` command, as the single published package ships it (t248, D23).
 *
 * A delegator and nothing else. The real command is `packages/surveyor/bin/surveyor.mjs`,
 ...
 * `@cartografo/surveyor` is a workspace symlink, and inside the published
...
await import('@cartografo/surveyor/bin/surveyor');
