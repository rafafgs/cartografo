#!/usr/bin/env node
/**
 * The `cost-surveyor` command, as the single published package ships it (t248, D23).
 *
 * A delegator and nothing else. The real command is `packages/cost-surveyor/bin/cost-surveyor.mjs`,
 ...
 * `@cartografo/cost-surveyor` is a workspace symlink, and inside the published
...
await import('@cartografo/cost-surveyor/bin/cost-surveyor');
