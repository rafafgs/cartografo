 ...
 * (`notes/2026-08-14-learning.md`). This module is the judgement itself,
 ...
 *
 * Two deliberate boundaries, in the same spirit as `domain/operations.ts`:
 *
 ...
 *   never validated on creation (`POST /v1/proposals` still does not, by
