 ...
 *
 * The same pattern as `packages/screen/test/no-privileged-access.test.ts`: the
 ...
 * coupling this test exists to prevent (same note as `packages/screen`).
 */
...
test('AT10 — packages/cost-surveyor declares no SQLite driver', () => {
...
test('AT11 — the gate sweep over packages/cost-surveyor flags nothing', () => {
