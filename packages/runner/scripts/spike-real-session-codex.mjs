...
const REQUESTED_FILE = 'PROOF-T119.md';
const PHRASE = 'real session of the Codex EngineAdapter';
...
function createDisposableRepo() {
  ...
  writeFileSync(join(repo, 'README.md'), '# Disposable repo of the t119 manual proof\n');
  git('add', '.');
