/**
 * D18 gate: no Portuguese code identifier left in `packages/screen` (t133, AC1).
 *
...
/** Every scanned file, as a path relative to `packages/screen`. */
...
test('AC1 — no Portuguese identifier survives in packages/screen/{src,test,bin}', () => {
...
test('AC1 — no file name under packages/screen/{src,test,bin} is in Portuguese', () => {
