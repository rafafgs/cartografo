 ...
 *
 * Port of `packages/cost-surveyor/test/no-portuguese-user-facing-strings.test.ts`,
...
const QUOTED_MACHINE_NAMES: readonly RegExp[] = Object.freeze([
  ...
  // kebab-case: `dry-run`, `cartografo-surveyor`
...
test('t247 — no Portuguese survives in a user-facing string of packages/surveyor', () => {
...
test('t247 — the sweep does NOT bite on this command’s English surface', () => {
  const allowed = [
    ...
    'cartografo-surveyor: unknown subcommand',
  ];
