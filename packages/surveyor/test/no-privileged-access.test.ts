 ...
 *
 * The same pattern as `packages/cost-surveyor/test/no-privileged-access.test.ts`
 * and `packages/screen/test/no-privileged-access.test.ts`: an observer is an
 ...
 *
 * One assertion of the sibling's is deliberately NOT ported. `cost-surveyor`
 ...
 * `@cartografo/cost-surveyor` by construction. D1/D11's line is about who
...
test('t247 AT8 — packages/surveyor declares no SQLite driver', () => {
...
test('t247 AT8 — the gate sweep over packages/surveyor flags nothing', () => {
